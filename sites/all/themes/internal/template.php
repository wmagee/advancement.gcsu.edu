<?php
// Georgia College Internal Theme

/**
 * Override or insert variables into the html template.
 */
function internal_preprocess_html(&$vars) {
  global $theme_key;
 ...
 */
/*
function internal_process_html(&$vars) {
  if (module_exists('color')) {
    _color_html_alter($vars);
  }
}
function internal_process_page(&$vars) {
  if (module_exists('color')) {
 ...
 */
function internal_preprocess_block(&$vars) {
 ...
 */
function internal_preprocess_field(&$vars) {
...
/*   Allows page template suggestions.  */
function internal_preprocess_page(&$vars) {
  if (isset($vars['node']->type)) {
    $vars['theme_hook_suggestions'][] = 'page__payment_request';
  }
}